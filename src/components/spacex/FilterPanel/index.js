...
import{ getAllFilteredItem } from '../../../redux/actions';
...
class FilterPanel extends React.Component {
    ...
    render() {
        ...
        return (
          ...
          >
            <h3>Filters</h3>
        <div className="header">Lunch Year {this.state.lunch}</div>
            <div className="buttonContainer" id="yearBtn">
              {lunchyears.length
            ...
            <div>
              <div className="header">Successful Lunch</div>
              <div className="buttonContainer" id="lunch">
                <Button
                  onClick={() =>
                    this.props.getAllFilteredItem(
                      this.state.lunch,
            ...
            <div>
              ...
              <div className="buttonContainer" id="landing">
                <Button
                  onClick={() =>
                    this.props.getAllFilteredItem(
                      this.state.lunch,
